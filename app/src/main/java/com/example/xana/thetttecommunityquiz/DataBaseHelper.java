...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    */
    ...
    public List<Questions> getAllAdminsQuestions(){
        ...
        quesList.add(new Questions( "What year was PE619's Tomy Thomas & The Magic Railroad was released?", "2012", "2010", "2008", "2015"));
        quesList.add(new Questions( "How many version of Percyengine619's Tomy James in a Mess are there?", "3", "2", "1", "4"));
        ...
        quesList.add(new Questions( "What was the first PE619 Sodor Race match?", "Thomas vs Percy", "Gordon vs Spencer", "Ben vs Douglas", "Oliver vs Henry"));
        ...
        quesList.add(new Questions( "What is Percyengine619 most-viewed video?", "Tomy Best of Gordon DVD", "Tomy Thomas & The Magic Railroad Chase Scene", "Tomy Hero of The Rails Full Movie", "Greatest Tomy Percy Accident "));
        quesList.add(new Questions( "What PE619 video did WoollyBearNO6Films themes make an appearance in?", "Tomy Thomas and Friends Henry's Accident Short ", "Tomy Sodor Races: Thomas vs Percy ", "Greatest Tomy Thomas Accident", "Tomy Sodor Races: Gordon vs Henry"));
        quesList.add(new Questions( "Who was the ghost engine from PE619 Tomy Duncan gets Spooked?", "Peter Sam", "Skarloey", "Sir Handel", "Duncan"));
        quesList.add(new Questions( "When did Tomy Hero of The Rails come out?", "July 2014", "June 2014", "July 2015", "August 1986"));
        quesList.add(new Questions( "Who was the main influence to PE619 channel?", "jjschepis3", "skullzproductions", "leokimvideo", "trainlover476"));
        ...
        quesList.add(new Questions( "What is the longest running joke in PE619 Tomy remakes?", "Sir Topham Hatt being bigger than all the humans.", "The tracks being blue rather than silver.", "The drivers being the same four drivers for all the engines.", "Bertie being bus"));
        quesList.add(new Questions( "What was the last remake of PE619 “The Dark Blue Walls Era”?", "Tomy Gordon & Spencer", "Tomy The Trouble With The Mud", "Tomy Educate Gordon Day", "Tomy Old Iron"));
        quesList.add(new Questions( "Who was the ghost train in PE619's Tomy Percy’s Ghostly Trick?", "Percy", "Thomas", "Stepney", "Oliver"));
        quesList.add(new Questions( "Why did PE619 chose UK Dub instead of US dub for Tomy Thomas & The Birthday Mail?", "ITS MEEEEEEEEEE!!", "US Dub wasn’t available", "DieselD199 requested for UK dub", "Editing Accident"));
        ...
        quesList.add(new Questions( "PE619 Tomy Bye George features an ____ George", "Ertl", "Tomy", "Wooden", "HO-Scale"));
        quesList.add(new Questions( "Who is Percyengine619 second favorite character?", "Diesel 10", "Edward", "Henry", "Duck"));
        quesList.add(new Questions( "What is the rarest Tomy item PE619 own?", "Tomy Old Slow Coach", "Tomy Gordon", "Tomy Angry Face Thomas", "Tomy Oliver"));
        quesList.add(new Questions( "How many express coaches do PE619 own?", "Too many to count", "2", "0", "1"));
        ...
        quesList.add(new Questions( "Where is Brendam Dock’s located in SKJ Productions series?", "Edward’s Branchline", "Thomas’ Branchline", "The Mainline", "Duck’s Branchline"));
