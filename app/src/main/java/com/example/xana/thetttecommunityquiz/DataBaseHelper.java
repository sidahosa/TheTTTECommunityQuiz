...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    */
    ...
    public List<Questions> getAllAdminsQuestions(){
        ...
        quesList.add(new Questions( "What is the name of EE93’s dog in real life?", "Watsonn", "Clarence ", "Shane Dooiney", "Waffles"));
        ...
        quesList.add(new Questions( "In ''The New Fuel'' Who brags he is ''better than diesels!'' and gets learns that not all diesels are bad?", "Gordon.", "BoCo.", "Thomas.", "In ''Market Day'' who ignores Toby's advice?"));
        quesList.add(new Questions( "Thomas.", "Percy.", "Edward.", "Henry. ", "Which branch line is known as the ''Little Western''?"));
        quesList.add(new Questions( "Duck and Oliver’s", "Thomas, Percy and Toby's.", "Edward's.", "Henry's.", "Who saved the day with their Moaning and weeshing?"));
        quesList.add(new Questions( "Duck.", "Oliver.", "Toby.", "Thomas. ", "In ''The Pride of Sodor'' who mistakes Sir Topham Hatts compliment?"));
        quesList.add(new Questions( "Thomas.", "Gordon.", "Duck", "Bertie the bus.", "What year did Season 1 of SKJ Productions begin?"));
        quesList.add(new Questions( "2013", "2012", "2014", "2015", "Which character is NOT in SKJ Productions series?"));
        quesList.add(new Questions( "Fearless Freddie", "Skarloey", "Bertram", "Duke", "How long was the break between Seasons 1 and 2 of SKJ Productions?"));
        quesList.add(new Questions( "2.5 Years", "2 Years", "1.5 Years", "1 Year", "How many Sodor Scenes videos are there currently?"));
        quesList.add(new Questions( "20 Sodor Scenes", "30 Sodor Scenes", "25 Sodor Scenes", "15 Sodor Scenes", "Which character currently has the most episodes to themself in SKJ Productions?"));
        quesList.add(new Questions( "Gordon", "Thomas", "James", "Percy", "What type of toy track does SKJ Productions film on?"));
        quesList.add(new Questions( "Blue Plarail/Tomica Track", "New gray TrackMaster Track", "Wooden Railway Track", "Tan TrackMaster Track", "Which country is Sidekickjason from?"));
        quesList.add(new Questions( "United States", "Great Britian", "Australia", "Sodor", "Which YouTuber greatly inspired Sidekickjason a long time ago to begin producing his series?"));
        quesList.add(new Questions( "DieselD199", "EnterprisingEngine93", "Percyengine619", "The Official Thomas & Friends Channel", "Currently, how often are new full episodes being released?"));
        quesList.add(new Questions( "Once every other week", "Twice a week", "Once a week", "Once a month", "Which YouTuber has written future stories that will be included in Seasons 3 and 4?"));
        quesList.add(new Questions( "Thomas&Friends47", "EnterprisingEngine93", "DieselD199", "CalebTrain", "In Inspector Troubles, which engines run into problems with a railway inspector?"));
        quesList.add(new Questions( "Bill & Ben", "Thomas & Percy", "Donald & Douglas", "Peter Sam & Sir Handel", "What type of video has SKJ Productions NOT yet produced?"));
        quesList.add(new Questions( "Music Video Remakes", "Audio Commentary", "Sneak Peeks", "Full Episode Remakes", "When did Season 2 begin airing?"));
        quesList.add(new Questions( "November 2015", "March 2014", "June 2014", "June 2015", "When did promotional videos for Season 2 begin airing?"));
        quesList.add(new Questions( "June 2015", "March 2014", "November 2015", "June 2014", "Who is the main character in the first episode of Season 2?"));
        quesList.add(new Questions( "BoCo", "Donald", "Mavis", "Skarloey", "After this quiz I’m for sure going to go like Sidekickjason’s facebook page at http://www.facebook.com/sidekickjason"));
        quesList.add(new Questions( "For sure! (Best choice)", "Maybe", "Nah", "I don’t have Facebook", "Where is Brendam Dock’s located in SKJ Productions series?"));
        quesList.add(new Questions( "Edward’s Branchline", "Thomas’ Branchline", "The Mainline", "Duck’s Branchline", "Which one of these characters is NOT in SKJ productions series?"));
        quesList.add(new Questions( "Jack", "Bertie ", "Harold", "Horrid Lorries", "Which editing Software does Sidekickjason edit on?"));
        quesList.add(new Questions( "Adobe Premiere", "Final Cut Pro", "Sony Vegas", "Windows Movie Maker", "What is the name of the teacher Thomas helps out in a calculus video?"));
        quesList.add(new Questions( "Who is Percyengine619 favorite character? ", "Percy", "Edward", "Diesel 10", "Oliver"));
        quesList.add(new Questions( "What colors is the sky for the layout?", "Light Blue", "Dark Blue", "Yellow", "White"));
