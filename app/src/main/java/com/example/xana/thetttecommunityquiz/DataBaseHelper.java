...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    */
    ...
    public List<Questions> getAllAdminsQuestions(){
        ...
        quesList.add(new Questions( "After this quiz I’m for sure going to go like Sidekickjason’s facebook page at http://www.facebook.com/sidekickjason", "For sure! (Best choice)", "Maybe", "Nah", "I don’t have Facebook"));
